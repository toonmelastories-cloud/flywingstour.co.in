...
export default function About() {
  ...
  useEffect(() => {
    document.title = "About Flywings Tour and Travel | Trusted Travel Experts";
    ...
    setMeta("description", "Learn about Flywings Tour and Travel — India's trusted travel agency for flight booking, holiday packages, visa services, and complete travel solutions. Meet our expert team.");
    setMeta("keywords", "about Flywings, trusted travel agency India, travel consultants, flight booking experts, visa services India, holiday packages");
    setMeta("og:title", "About Flywings Tour and Travel | Trusted Travel Experts", "property");
    setMeta("og:description", "Over a decade of crafting dream journeys. Meet the passionate team behind Flywings — India's trusted travel partner.", "property");
      ...
      "@graph": [
        {
          ...
          "logo": "https://flywings.in/logo.png",
          ...
          "sameAs": ["https://www.facebook.com/flywings", "https://www.instagram.com/flywings", "https://www.linkedin.com/company/flywings"]
        },
        {
          "@type": "LocalBusiness",
          "name": "Flywings Tour and Travel",
    ...
    const s = document.getElementById("about-schema") || document.createElement("script");
    s.setAttribute("type", "application/ld+json"); s.id = "about-schema";
