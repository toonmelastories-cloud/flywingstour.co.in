...
export default function DestinationsPage() {
  ...
  useEffect(() => {
    document.title = "Travel Destinations | Dubai, Thailand, Bali & More | Flywings";
    const desc = document.querySelector('meta[name="description"]') || document.createElement("meta");
    desc.setAttribute("name", "description");
    desc.setAttribute("content", "Explore top international travel destinations from India — Dubai, Thailand, Bali, Kashmir, Maldives, Singapore. Best tour packages with flights & hotels. Book with Flywings.");
