...
const packages: PackageData[] = [
  ...
  // ─── DUBAI CLASSIC ─────────────────────────────────────────
  {
    ...
    badge: "Best Value",
    overview:
      "Experience the best of Dubai in a perfectly paced 4 Nights / 5 Days itinerary. From the iconic Burj Khalifa and sprawling Dubai Mall to the magical golden desert and glistening Marina, this classic package covers Dubai's must-see highlights at exceptional value. Ideal for first-time visitors, budget-conscious travelers, and short holiday seekers — this affordable Dubai tour package from India delivers an unforgettable experience without compromising on quality.",
    itinerary: [
      {
        day: 1,
        title: "Arrival & Old Dubai Discovery",
        description: "Land in Dubai and kick off your adventure with a taste of traditional Dubai.",
        activities: [
          "Airport pickup and hotel check-in",
          "Dubai Museum & Al Fahidi Historic District",
          "Dubai Creek abra (traditional boat) ride",
          "Gold Souk & Spice Market evening walk",
        ],
        meals: "—",
        hotel: "Hilton Dubai Creek / Similar 4★",
      },
      {
        day: 2,
        title: "Modern Dubai — Burj Khalifa & The Dubai Mall",
        description: "Experience the awe-inspiring height of Burj Khalifa and shop at one of the world's largest malls.",
        activities: [
          "Burj Khalifa 124th floor 'At the Top'",
          "Dubai Mall & indoor aquarium",
          "Dubai Fountain show (evening)",
          "Dinner at Dubai Mall food court or restaurant",
        ],
        meals: "Breakfast",
        hotel: "Hilton Dubai Creek / Similar 4★",
      },
      {
        day: 3,
        title: "Desert Safari — Dune Adventure",
        description: "Thrilling afternoon in the desert dunes followed by a magical Bedouin-style evening.",
        activities: [
          "Morning leisure or optional Heritage Village",
          "Desert dune bashing (4x4)",
          "Camel ride & sandboarding",
          "BBQ dinner with cultural performances",
        ],
      ...
      },
      {
        ...
        description: "Explore the Palm and relax at JBR beach before an evening on the Marina.",
        activities: [
          "Palm Jumeirah monorail ride",
          "JBR Beach & The Walk",
          "Dubai Marina evening stroll",
      ...
      },
      {
        day: 5,
        title: "Departure",
        description: "Buffet breakfast, last-minute shopping, and departure.",
        activities: [
          "Buffet breakfast",
          "Check-out and hotel to airport transfer",
          "Duty Free shopping at DXB",
          "Departure",
        ],
        meals: "Breakfast",
      },
    ...
    exclusions: [
      ...
      "Optional Dhow Cruise, Atlantis, Aquaventure",
    ...
    hotels: [
      {
        ...
        stars: 4,
        location: "Al Rigga, Deira — central Dubai",
        roomType: "Superior King Room",
        upgradeOption: "Upgrade to Creek View Room (+₹4,000/night)",
      },
    ],
    pricingTiers: [
      {
        ...
        price: "₹49,999",
        originalPrice: "₹65,000",
        description: "2 adults sharing one room — most popular",
      },
      {
        label: "Per Person (Triple Sharing)",
        price: "₹44,999",
    ...
    childPrice: "₹22,000 (age 2–11, sharing parents' room)",
    emiAvailable: true,
    cancellationPolicy: [
      "Free cancellation up to 30 days before departure — full refund",
    ...
    faqs: [
      {
        ...
        answer:
          "Included are return economy flights, 4★ hotel for 4 nights with breakfast, UAE visa, all transfers, desert safari with dinner, and Burj Khalifa entry. See full inclusions list above.",
      },
      {
        question: "Is this package suitable for families with children?",
        answer:
          "Absolutely! Dubai is extremely family-friendly. Children aged 2–11 can join for ₹22,000 (sharing parents' room). Activities like Dubai Mall, Aquaventure, IMG Worlds, and beach days are perfect for kids.",
      },
      {
        question: "Can I upgrade to a 5★ hotel?",
        answer:
          "Yes. We offer easy upgrades to 5★ properties like JW Marriott or Sofitel at additional cost. Contact our team to get a customized quote.",
      },
      {
        question: "What documents are needed for the UAE visa?",
        answer:
          "You'll need a valid Indian passport (6+ months validity), 2 passport photos, bank statement (last 3 months), and salary slips or ITR. Our team will guide you through every step.",
      },
    ],
    ...
    metaDescription:
      "Best Dubai 4 Nights 5 Days tour package from India starting ₹49,999. Flights, 4★ hotel, desert safari, Burj Khalifa & visa included. Book now!",
